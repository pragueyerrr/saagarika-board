...
`
  ...
  const response = await anthropic.messages.create({
    ...
    max_tokens: 600,
    system: 'You are a career coach specializing in data analysis, business intelligence, market research, and insights roles. Respond only with valid JSON, no markdown.',
    messages: [
      {
        role: 'user',
